...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        ...
        os.path.abspath(os.path.dirname(__file__)), "default_app.db"
    )
    ...
    MAIL_DEFAULT_SENDER = (
        os.environ.get("MAIL_DEFAULT_SENDER") or "noreply@kvnbbg-creations.io"
    )
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        ...
        os.path.abspath(os.path.dirname(__file__)), "dev_app.db"
    )
...
def update_zshrc():
    ...
    print(
        f"Configuration added to {zshrc_path}. Please restart your shell or run `source {zshrc_path}`."
    )
